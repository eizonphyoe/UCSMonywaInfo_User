...
public class Utils {
    ...
    public static String DateToTimeFormat(String oldstringDate) {
        if (oldstringDate == null || oldstringDate.isEmpty()) {
            return "";
        }
        ...
        try {
            ...
            // Try standard datetime format (from Firebase)
            try {
    ...
    public static String DateFormat(String oldstringDate) {
        ...
        try {
            ...
            // Try standard datetime format (from Firebase)
            try {
                Date date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.ENGLISH).parse(oldstringDate);
                newDate = dateFormat.format(date);
            } catch (ParseException ex) {
                // Return original string if parsing fails
